...
function frenzy_enqueue_modular_scripts() {
    ...
    if (is_product() || is_cart() || is_checkout()) {
        wp_enqueue_style('frenzy-frontend-style', $base_url . 'assets/css/frontend.css', [], '1.9.7');
    }
    ...
    if (is_product()) {
        ...
        foreach ($scripts as $handle => $path) {
            ...
            wp_enqueue_script($handle, $base_url . $path, $deps, '1.9.7', true);
        }
        ...
        $localized_data = [
            ...
            'region'     => $grid,
            'can_edit_grid' => current_user_can('manage_woocommerce') || current_user_can('manage_options'),
        ];
